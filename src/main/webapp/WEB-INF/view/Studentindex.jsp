    ...
    <header>
       <h1>Welcome ${name}</h1>
        ...
        <div class="button-box">
            ...
            <a href="searchstudenttrainingschedule/${student}">Training Schedule</a>
            <p>View training Schedule</p>
        </div>
        <div class="button-box">
            <i class="icon fas fa-chalkboard-teacher"></i>
            <a href="showallcourse1">View Course</a>
            <p>View Course Details</p>
        </div>
        <div class="button-box">
            <i class="icon fas fa-graduation-cap"></i>
            <a href="studentdetails/${student}">View Profile Student</a>
            <p>View Profile Student.</p>
        </div>
        <div class="button-box">
            <i class="icon fas fa-graduation-cap"></i>
            <a href="studentfeedback">Feedback</a>
